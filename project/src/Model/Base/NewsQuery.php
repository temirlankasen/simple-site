...
use Site\Model\News as ChildNews;
use Site\Model\NewsQuery as ChildNewsQuery;
use Site\Model\Map\NewsTableMap;
 ...
 * @method     ChildNewsQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildNewsQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildNewsQuery orderByDigest($order = Criteria::ASC) Order by the digest column
 ...
 * @method     ChildNewsQuery groupByName() Group by the name column
 * @method     ChildNewsQuery groupByDescription() Group by the description column
 * @method     ChildNewsQuery groupByDigest() Group by the digest column
 ...
 * @method     ChildNews findOneByName(string $name) Return the first ChildNews filtered by the name column
 * @method     ChildNews findOneByDescription(string $description) Return the first ChildNews filtered by the description column
 * @method     ChildNews findOneByDigest(string $digest) Return the first ChildNews filtered by the digest column
 ...
 * @method     ChildNews requireOneByName(string $name) Return the first ChildNews filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildNews requireOneByDescription(string $description) Return the first ChildNews filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildNews requireOneByDigest(string $digest) Return the first ChildNews filtered by the digest column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildNews[]|ObjectCollection findByName(string $name) Return ChildNews objects filtered by the name column
 * @method     ChildNews[]|ObjectCollection findByDescription(string $description) Return ChildNews objects filtered by the description column
 * @method     ChildNews[]|ObjectCollection findByDigest(string $digest) Return ChildNews objects filtered by the digest column
...
abstract class NewsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Site\Model\Base\NewsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'site', $modelName = '\\Site\\Model\\News', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, description, digest, created_at FROM news WHERE id = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NewsTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NewsTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByDigest($digest = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NewsTableMap::COL_DIGEST, $digest, $comparison);
    }
