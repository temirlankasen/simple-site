...
class ServiceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ServiceTableMap';
     ...
     */
    const OM_CLASS = '\\Site\\Model\\Service';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Service';
     ...
     */
    const COL_ID = 'service.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'service.name';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'service.description';

    /**
     * the column name for the digest field
     */
    const COL_DIGEST = 'service.digest';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'service.created_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Description', 'Digest', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'description', 'digest', 'createdAt', ),
        self::TYPE_COLNAME       => array(ServiceTableMap::COL_ID, ServiceTableMap::COL_NAME, ServiceTableMap::COL_DESCRIPTION, ServiceTableMap::COL_DIGEST, ServiceTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'description', 'digest', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Description' => 2, 'Digest' => 3, 'CreatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'digest' => 3, 'createdAt' => 4, ),
        self::TYPE_COLNAME       => array(ServiceTableMap::COL_ID => 0, ServiceTableMap::COL_NAME => 1, ServiceTableMap::COL_DESCRIPTION => 2, ServiceTableMap::COL_DIGEST => 3, ServiceTableMap::COL_CREATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'digest' => 3, 'created_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Site\\Model\\Service');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('service_id_seq');
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 255, null);
        $this->addColumn('description', 'Description', 'LONGVARCHAR', false, null, null);
        $this->addColumn('digest', 'Digest', 'LONGVARCHAR', false, null, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ServiceTableMap::COL_ID);
            $criteria->addSelectColumn(ServiceTableMap::COL_NAME);
            $criteria->addSelectColumn(ServiceTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(ServiceTableMap::COL_DIGEST);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Site\Model\Service) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ServiceTableMap::DATABASE_NAME);
            $criteria->add(ServiceTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ServiceTableMap::COL_ID) && $criteria->keyContainsValue(ServiceTableMap::COL_ID) ) {
