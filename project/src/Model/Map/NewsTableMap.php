...
class NewsTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Site\\Model\\News';
     ...
     */
    const COL_NAME = 'news.name';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'news.description';

    /**
     * the column name for the digest field
     */
    const COL_DIGEST = 'news.digest';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID, NewsTableMap::COL_NAME, NewsTableMap::COL_DESCRIPTION, NewsTableMap::COL_DIGEST, NewsTableMap::COL_CREATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID => 0, NewsTableMap::COL_NAME => 1, NewsTableMap::COL_DESCRIPTION => 2, NewsTableMap::COL_DIGEST => 3, NewsTableMap::COL_CREATED_AT => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Site\\Model\\News');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('news_id_seq');
        // columns
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsTableMap::COL_NAME);
            $criteria->addSelectColumn(NewsTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(NewsTableMap::COL_DIGEST);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Site\Model\News) { // it's a model object
