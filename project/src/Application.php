...
use Site\Module\AjaxModule;
use Site\Module\CommandModule;
use Site\Module\ControllerModule;
...
//        $this->addDefinitions(__DIR__ . '/../src/Resource/config/services_ajax_http.php', 'http');
...
//        $this->addModule(new AjaxModule(),       'http');
    }
